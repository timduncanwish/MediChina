...
export const products: Product[] = [
  {
    ...
    images: ["/images/products/whole-body-mri.svg"],
  ...
  },
  {
    ...
    images: ["/images/products/mri-health-checkup.svg"],
    calendlyEventType: null,
    reviewsCount: 15,
    averageRating: 5.0,
    isActive: true,
  ...
  },
  {
    ...
    images: ["/images/products/baseline-checkup.svg"],
    calendlyEventType: null,
    reviewsCount: 18,
    averageRating: 4.8,
    isActive: true,
  ...
  },
  {
    ...
    images: ["/images/products/expanded-checkup.svg"],
    calendlyEventType: null,
    reviewsCount: 14,
    averageRating: 4.9,
    isActive: true,
  ...
  },
  {
    ...
    images: ["/images/products/intensive-checkup.svg"],
    calendlyEventType: null,
    reviewsCount: 10,
    averageRating: 5.0,
    isActive: true,
  ...
  },
  {
    ...
    images: ["/images/products/comprehensive-checkup.svg"],
    calendlyEventType: null,
    reviewsCount: 11,
    averageRating: 5.0,
    isActive: true,
  ...
  },
  {
    ...
    images: ["/images/products/skin-analysis.svg"],
    calendlyEventType: null,
    reviewsCount: 8,
    averageRating: 4.7,
    isActive: true,
  ...
  },
  {
    ...
    images: ["/images/products/hair-analysis.svg"],
    calendlyEventType: null,
    reviewsCount: 6,
    averageRating: 4.6,
    isActive: true,
  ...
  },
  {
    ...
    images: ["/images/products/vision-exam.svg"],
    calendlyEventType: null,
    reviewsCount: 9,
    averageRating: 4.8,
    isActive: true,
  ...
  },
  {
    ...
    images: ["/images/products/womens-health.svg"],
    calendlyEventType: null,
    reviewsCount: 7,
    averageRating: 4.9,
    isActive: true,
...
export const testimonials = [
  ...
  {
    quote:
      "From Singapore, Korea is just a short flight. Himedi coordinated my entire trip — the MRI scan was incredibly detailed and the report was translated within a week.",
    name: "Wei Lin Tan",
    nationality: "Singapore",
    countryFlag: "🇸🇬",
    service: "Whole Body MRI",
    rating: 5,
  },
  {
    quote:
      "The whole-body screening was thorough and professional. I received my translated results digitally, which I shared with my doctor back home. Highly recommended.",
    name: "Thomas Weber",
    nationality: "Germany",
    countryFlag: "🇩🇪",
    service: "MRI + Health Checkup",
